...
if(isset($_POST["txtDescripcion"]))
{
	if($_POST["txtDescripcion"]!="")
	{
		...
		$qry = "update informacion set FechaCargado='".date("Y-m-d")."', Descripcion='$descripcion' where idInformacion =".$_GET['idI'];
		mysqli_query($c, $qry);
		$msg = "<div class='alert alert-success' role='alert'>Se actualizo correctamente la informaci&oacute;n</div>";
	}
	else
	{
...
<form class="container-sm" method="post" enctype="multipart/form-data" action="editarInfo.php?idI=<?php echo $_GET['idI']; ?>" onsubmit="return validaFRM()">	
<a class="btn btn-light float-lg-start" href="cambiarInformacion.php"><i class="fas fa-arrow-left"></i></a> 
	<div class="container-sm">
		<h3>Formulario para cambiar información</h3>
		<?php
			if($msg!="")echo "<div id=\"txtMsg\">$msg</div>";
		?> <br>
		Descripción:<textarea class="form-control me-2" rows="4" cols="70" id="txtDescripcion" name="txtDescripcion"></textarea><br>
		<div class="d-flex btn-group" role="group">
	  		<input class="form-control me-2 btn btn-outline-primary" type="submit" value="Actualizar Informaci&oacute;n">
